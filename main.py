    ...
    if res.pose_landmarks and inFrame(finalres):
        if not(isInit):
            ...
            if isRunning(): ##  running down the d key
                ...
                cv2.putText(frm, "You are still", (50,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2)
        ...
        cv2.putText(frm, "Make Sure full body in frame", (50,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,255,255), 2)
